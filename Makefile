...
CXXFLAGS=-std=c++11 -Wall  -Wno-comment -Wno-error=comment -march=native -O2 -g `pkg-config --cflags-only-I sdl2` -I/usr/include/malloc -DGL_GLEXT_FUNCTION_POINTERS=1
